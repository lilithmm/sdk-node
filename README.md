...
Authorize.Net is phasing out the MD5 based *transHash* element in favor of the SHA-512 based *transHashSHA2*. The MD5 Hash setting in the Merchant Interface is no longer available, and the *transHash* element will stop returning values at a later date to be determined. For information on how to use *transHashSHA2*, please see the [Transaction Hash Upgrade Guide](https://developer.authorize.net/support/hash_upgrade/).
